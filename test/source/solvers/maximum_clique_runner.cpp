...
TEST_SUITE("maximum_clique")
{
  TEST_CASE_TEMPLATE("dump all maximum_clique dataset" * doctest::skip(true),
                     V,
                     integer<1>,
                     integer<2>,
                     integer<3>,
                     ...
                     integer<8>)
  {
    ...
    auto solutions = solve_all_maximum_clique(graphs);
    write_solution_to_csv(solutions, std::format("maximum_clique_of_undirected_connected_graphs_size_{}.csv", V::v));
  }
}
